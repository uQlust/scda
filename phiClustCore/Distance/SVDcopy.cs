...
namespace Distance
{
	...
	public class SVD
	{
		...
		/// </summary>
        private static double[] s = new double[3];
        private static double[,] U = new double[3, 3];
        private static double[,] V = new double[3, 3];
        //private double[] e = new double[3];
        //private double[] work = new double[3];
		...
		public SVD(double[,] A)
		{
            ...
            int nct = 2;// System.Math.Min(m - 1, n);
            int nrt = 1;// System.Math.Max(0, System.Math.Min(n - 2, m));
			for (int k = 0; k < 2;k++)//System.Math.Max(nct, nrt); k++)
			{
				if (k < nct)
				{
