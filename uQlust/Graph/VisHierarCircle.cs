...
namespace Graph
{
    ...
    public partial class VisHierarCircle : Form, SavePic,IVisual
    {
        ...
        string measureName;
        ClusterOutput outp;
        public VisHierarCircle(ClusterOutput outp, string name, string measureName)
        {
            this.outp = outp;
...
//            CC = 0;
            ...
            else
            {
                ...
                if (remNode != null)
                {
                    visHierar dendrog = new visHierar(remNode, outp,"", measureName, null);
                    dendrog.Show();
                }
            }
        }
